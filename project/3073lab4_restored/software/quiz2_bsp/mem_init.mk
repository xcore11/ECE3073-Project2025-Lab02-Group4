...
# Memory: control_mem
MEM_0 := NIOSII_WEEK3_control_mem
$(MEM_0)_NAME := control_mem
...
$(MEM_0)_HIERARCHICAL_PATH := control_mem
$(MEM_0)_WIDTH := 32
...
.PHONY: control_mem
control_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
