...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../NIOSII_WEEK3.sopcinfo
...
# CPU Name 
# setting CPU_NAME is control_proc
CPU_NAME = control_proc
...
# Design Name 
# setting SOPC_NAME is NIOSII_WEEK3
SOPC_NAME := NIOSII_WEEK3
...
# setting hal.stderr is jtag_control
ELF_PATCH_FLAG  += --stderr_dev jtag_control

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_control
ELF_PATCH_FLAG  += --stdin_dev jtag_control
...
# setting hal.stdout is jtag_control
ELF_PATCH_FLAG  += --stdout_dev jtag_control
