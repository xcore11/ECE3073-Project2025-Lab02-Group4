...
# Memory: image_mem
MEM_0 := NIOSII_WEEK3_image_mem
$(MEM_0)_NAME := image_mem
...
$(MEM_0)_HIERARCHICAL_PATH := image_mem
$(MEM_0)_WIDTH := 32
...
.PHONY: image_mem
image_mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
