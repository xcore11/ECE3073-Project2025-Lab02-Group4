...
# CPU Name 
# setting CPU_NAME is image_proc
CPU_NAME = image_proc
...
# setting hal.stderr is jtag_image
ELF_PATCH_FLAG  += --stderr_dev jtag_image

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_image
ELF_PATCH_FLAG  += --stdin_dev jtag_image
...
# setting hal.stdout is jtag_image
ELF_PATCH_FLAG  += --stdout_dev jtag_image
